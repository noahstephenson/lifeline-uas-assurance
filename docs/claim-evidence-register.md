...
| Testing exposed useful integration issues | demonstrated | D-01 through D-09 cover readiness, provenance, artifact integrity, configurable ports, timing allowance, framework startup, launcher parsing, cross-shell detection, and venv/path finalization. Do not imply these were flight-safety findings. |
