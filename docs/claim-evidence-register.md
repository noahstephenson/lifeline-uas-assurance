...
| Testing exposed useful integration issues | demonstrated | D-01 through D-10 cover readiness, provenance, artifact integrity, configurable ports, timing, framework startup, cross-shell setup, venv/path finalization, and bounded SITL launch failures. Do not imply these were flight-safety findings. |
