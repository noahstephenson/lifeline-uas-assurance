...
| Testing exposed useful integration issues | demonstrated | D-01 through D-13 cover readiness, provenance, artifact integrity, configurable ports, timing, framework startup, cross-shell setup, venv/path finalization, bounded SITL launch failures, background WSL argument boundaries, the pinned MAVSDK identity contract, and persistent live telemetry. Do not imply these were flight-safety findings. |
