...
| Testing exposed useful integration issues | demonstrated | D-01 through D-11 cover readiness, provenance, artifact integrity, configurable ports, timing, framework startup, cross-shell setup, venv/path finalization, bounded SITL launch failures, and background WSL argument boundaries. Do not imply these were flight-safety findings. |
