...
| Testing exposed useful integration issues | demonstrated | D-01 through D-12 cover readiness, provenance, artifact integrity, configurable ports, timing, framework startup, cross-shell setup, venv/path finalization, bounded SITL launch failures, background WSL argument boundaries, and the pinned MAVSDK identity contract. Do not imply these were flight-safety findings. |
